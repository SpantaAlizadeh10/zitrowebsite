...
const products: Product[] = [
  {
    ...
    specifications: {
      ...
      capacity: "380 لیتر",
      energy: "A++",
      features: ["دوربین داخلی", "نمایشگر لمسی", "سردکن سریع"]
    }
  },
  {
    id: 2,
    ...
    specifications: {
      ...
      capacity: "9 کیلوگرم",
      energy: "A+++",
      features: ["شستشوی بخار", "موتور اینورتر", "کنترل هوشمند"]
    }
  }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-3">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold">لوازم خانگی</h2>
            <select
              value={sortBy}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProducts.map((product) => (
              <Link
                key={product.id}
                href={`/products/appliance/${product.brand}/${product.id}`}
              ...
              >
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>ظرفیت: {product.specifications.capacity}</p>
                  <p>رتبه انرژی: {product.specifications.energy}</p>
